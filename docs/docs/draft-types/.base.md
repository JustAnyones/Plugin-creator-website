...
This sound will be played when clicked on them in default mode.
...
- Using a helper script `#LuaWrapper` for [Real time script editing](../guides/real-time-script-editing.md):
```json
{
    "script": "#LuaWrapper",
    "meta": {
